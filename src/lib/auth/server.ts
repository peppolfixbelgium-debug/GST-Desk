...
// Accept the canonical auth URL AND the actual Vercel deployment/production
// origins. Vercel's deployment URL is a valid first-party origin, and omitting
// it causes Better Auth to reject both credential sign-up and OAuth initiation
// with "Invalid origin" when the user opens a deployment alias.
